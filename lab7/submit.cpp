                   ...
                   if(j -> current_location == j -> destination_city){
                    //cout << "DESTINATION CITY : " << j -> current_location << endl;
                     ...
                     for(auto &parcel : j -> parcels){
                        ...
                        //  if(find(it->all_parcels.begin(),it->all_parcels.end(),parcel)!=it->all_parcels.end()){
                        // it->all_parcels.erase(find(it->all_parcels.begin(),it->all_parcels.end(),parcel));
                        //   }

                        for(auto vertex : this -> vertices){
                            if(vertex -> name == parcel -> destination){
                        ...
                        for(auto vertex : this -> vertices){
                            if(vertex -> name == parcel -> origin){
                                     if(find(vertex->all_parcels.begin(),vertex->all_parcels.end(),parcel)!=vertex->all_parcels.end()){
                                  it->all_parcels.erase(find(vertex->all_parcels.begin(),vertex->all_parcels.end(),parcel));
                                }
                                break;
                            }
                        }

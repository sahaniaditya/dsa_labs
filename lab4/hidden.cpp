...
void test_successor_predecessor_withkey() {
    ...
    //cout << node -> getDepartureTime();
    //cout << endl;
    //cout << node1 -> getDepartureTime() ;
    //cout << "here" << endl;
...
void test_book_trip() {
    ...
    cout << (firstBooking == nullptr) << endl;
...
int main() {
    ...
    //cout << "i am good2" << endl;
    test_show_trips_by_time();
    //cout << "i am good3" << endl;
    //test_searchkeyin_BST();
    //cout << "i am good4" << endl;
